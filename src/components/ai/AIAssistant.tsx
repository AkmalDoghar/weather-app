  ...
  return (
    <>
      <motion.button
        ...
        className="fixed z-[70] w-14 h-14 rounded-2xl bg-gradient-to-br from-sky-500 to-indigo-600 shadow-2xl shadow-sky-500/40 flex items-center justify-center border border-white/20 transition-all cursor-grab active:cursor-grabbing"
        style={launcherStyle}
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`fixed z-[60] w-[92vw] max-w-[420px] sm:w-[440px] rounded-3xl overflow-hidden shadow-2xl border ${
              isDarkMode
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              ...
              {thinking && (
                <div className="flex gap-2.5">
                  ...
                  <div
                    className={`px-3.5 py-2.5 rounded-2xl rounded-tl-sm text-xs ${isDarkMode ? "bg-white/10 border border-white/10" : "bg-slate-100 border border-slate-200"}`}
                  >
            ...
            <div
              className={`flex items-center gap-2 px-4 py-3 border-t ${isDarkMode ? "border-white/10" : "border-black/10"}`}
            >
              <input
                value={input}
